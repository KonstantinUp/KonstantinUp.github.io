...
game.newLoopFromConstructor('myGame', function () {
    ...
    game.newLoopFromConstructor('loading', function () {
        ...
        let loading = game.newRectObject({
            x: game.getWH2().w,
            y: game.getWH2().h,
            w: 2,
            h: 30,
        ...
        let percent = 0;
        let timer = pjs.OOP.newTimer(500, function () {

            let step = math.random(0, 10);
            percent = percent + step;
            loading.w = loading.w + step * 5;
        });
        ...
        this.update = function () {
            ...
            if (percent <= 100) {
                ...
                loading.x = game.getWH2().w - 200;
                loading.y = game.getWH2().h + 50;
                loading.draw();
            }

            if (percent > 100) {
                game.setLoop('gameStart');
